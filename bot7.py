...
# ===== Pinterest =====
def download_pinterest_media(url, output_dir="C:\\Users\\dimag\\OneDrive\\Документы\\proect-yandex3\\files\\pinterest_file"):
...
#print(download_pinterest_media('https://ru.pinterest.com/pin/958914945638097196/'))
print(download_pinterest_media('https://ru.pinterest.com/pin/658088564339212753/feedback/?invite_code=24db2988ff914857b5714eed38401df5&sender_id=744290413325868558'))